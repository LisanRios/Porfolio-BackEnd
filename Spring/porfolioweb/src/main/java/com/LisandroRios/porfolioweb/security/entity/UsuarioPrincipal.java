package com.LisandroRios.porfolioweb.security.entity;
...
public class UsuarioPrincipal implements UserDetails {
    ...
    public UsuarioPrincipal(String nombre, String nombreUsuario, String email, String password, Collection<? extends GrantedAuthority> autority) {
        this.nombre = nombre;
        this.nombreUsuario = nombreUsuario;
        this.email = email;
        this.password = password;
        this.autorities = autority;
    }
